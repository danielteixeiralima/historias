...
# Função para gerar HTML da capa
    ...
    <div class='pagina capa'>
        <div class='conteudo'>
            <div class='imagem-container'>
                <img class='imagem' src='data:image/png;base64,{imagem_base64}' alt='Capa'>
...
# Função para gerar HTML das páginas internas com texto e imagem
def gerar_html_pagina(texto, imagem_base64, pagina_numero, logo_base64):
    logging.info(f"Gerando HTML da página {pagina_numero}...")
    texto_escapado = html.escape(texto)
    html_content = f"""
    <div class='pagina'>
        <div class='conteudo'>
            <div class='imagem-container'>
                <img class='imagem' src='data:image/png;base64,{imagem_base64}' alt='Imagem da página {pagina_numero}'>
...
# Função para gerar HTML da página de agradecimento com imagem de fundo, texto e logos
...
Família Mopi
    ...
    # CSS específico para a página de agradecimento
    css_agradecimento = """
  <style>
  .pagina.agradecimento .texto-agradecimento {
      font-size: 12px;
      text-align: center;
      color: #000;
      line-height: 1.4;
    ...
    <div class='pagina agradecimento'>
        ...
        <div class='conteudo'>
            <div class='imagem-container'>
                <img class='imagem' src='data:image/png;base64,{imagem_base64}' alt='Agradecimento'>
...
# Função para gerar HTML da contracapa com texto de despedida e pequenos logos
...
Agradecemos profundamente a todos que contribuíram para este projeto inovador e estamos entusiasmados em continuar trazendo soluções que encantam, inspiram e transformam a educação.
    ...
    # CSS específico para a contracapa
    css_contracapa = """
    <style>
    .pagina.contracapa .texto-despedida {
        font-size: 12px;
        text-align: center;
        color: #000;
        line-height: 1.4;
    ...
    .pagina.contracapa .logos-container {
        margin-top: 20px;
        display: flex;
    ...
    .pagina.contracapa .logo-pequena {
        max-width: 100px;
        max-height: 50px;
        object-fit: contain;
    }
    .pagina.contracapa .logo-mopi {
        position: relative;
        top: -10px;
    }
    </style>
    ...
    <div class='pagina contracapa'>
        ...
        <div class='conteudo'>
            <div class='imagem-container'>
                <img class='imagem' src='data:image/png;base64,{imagem_base64}' alt='Contracapa'>
                <div class='texto-despedida'>
                    {formatted_text}
                    <div class='logos-container'>
                        <img class='logo-pequena logo-mopi' src='data:image/png;base64,{logo_mopi_base64}' alt='Logo Mopi'>
                        <img class='logo-pequena' src='data:image/png;base64,{logo_inovai_base64}' alt='Logo Inovai.lab'>
                    </div>
                </div>
            </div>
        </div>
...
def gerar_pdf_livro(titulo_capa, historias, imagens_base64, historia_texto, estilo_imagem, nome_pdf, logo_base64, pasta_destino):
    ...
    imagem_agradecimento = gerar_agradecimento(titulo_capa, historia_texto, estilo_imagem)
    html_agradecimento = gerar_html_agradecimento(imagem_agradecimento, logo_base64)

    # Gerar HTML das páginas internas
    html_paginas = ""
    for i, (texto, imagem_base64) in enumerate(zip(historias, imagens_base64[1:-1]), start=1):
...
# Função para formatar e gerar o livro infantil
def formatar_como_livro_infantil(arquivo_word=None, preferencias=None, interesses=None, caracteristicas=None):
    try:
        historia_texto = ""
        titulo = ""
        estilo_imagem = ""
